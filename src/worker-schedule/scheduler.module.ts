...
import { resolvePlayerRootPath } from '../config/paths';
...
// Manifests are published per screen, with devices resolved from the database.
const PLAYER_MANIFEST_BUCKET =
  ...
  '';
const PLAYER_MANIFEST_PREFIX = process.env.PLAYER_MANIFEST_PREFIX || 'manifests';
