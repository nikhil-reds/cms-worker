...
const EnvSchema = z.object({
  ...
  RABBITMQ_PLAYLIST_RENDER_QUEUE: z.string().default('playlist.render.requested'),
  RABBITMQ_PLAYLIST_RENDER_RETRY_QUEUE: z.string().default('playlist.render.retry'),
  RABBITMQ_PLAYLIST_RENDER_DLQ: z.string().default('playlist.render.dead_letter'),
  RABBITMQ_PLAYLIST_RENDER_MAX_RETRIES: z.coerce.number().int().min(0).default(3),
  RABBITMQ_PLAYLIST_RENDER_RETRY_DELAY_MS: z.coerce.number().int().positive().default(10000),
